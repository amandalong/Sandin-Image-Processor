...
Instead of turning the dials by hand the Oscillator can generate its own signal or drive the video. For example in the configuration shown bwlow: CAMERA + OSC -> COMPARATOR (using both video and osc inputs) -> MONITOR. The modules can be chained to create more complicated array of effects. 
_Comparator module example generated by Oscillator (sine wave) - note the green input_ 
![preview](https://github.com/amandalong/amandalong/blob/c090e308c43edd7955185ffa1a4f73e661c41cd2/Images/Comparator%20and%20Osc.png)

![preview](https://github.com/amandalong/amandalong/blob/ddaab6664ac2f3ce6a26848e664160146ed0e9cc/Images/Comparator%20generated%20by%20OSC-low.gif)
