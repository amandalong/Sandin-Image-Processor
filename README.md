...
An example configuration: CAMERA + OSC -> COMPARATOR (using both video and osc inputs) -> MONITOR. The modules can be chained to create more complicated array of effects. _Connecting cables can only be done when the patch is unlocked
